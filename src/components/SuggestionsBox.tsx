                ...
                {posts.map((post, idx) => {
                  ...
                  return (
                    <Button
                      ...
                      className={
                        `w-full h-1/5 text-left p-2 rounded-md flex flex-row md:flex-row items-start md:items-center gap-3
                    ...
                    >
                      ...
                      {/* <div className="flex flex-col items-center gap-2 md:flex-col md:items-end"> */}
                        <div className="flex flex-col gap-2 items-start hidden md:flex">
                          {(post.tags ?? []).slice(0,2).map((t, i) => (
                            <span
                              key={i}
                              className="bg-gray-200 text-xs text-gray-700 px-2 py-0.5 rounded-md"
                            >
                              {String(t).trim()}
                            </span>
                          ))}
                        ...
                        <div className="flex flex-row items-center text-xs text-gray-700 ml-2 md:ml-0">
